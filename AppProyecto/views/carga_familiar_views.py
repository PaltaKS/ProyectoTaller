...
def crear_carga_familiar(request):
    if request.method == 'POST':
        ...
        CargaFamiliarService.crear_carga(trabajador_id, nombre, parentesco, genero, rut)
        return redirect('listar_cargas_familiares')

    trabajadores = Trabajador.objects.all()
    return render(request, 'CargaFamiliar/formulario.html', {'trabajadores': trabajadores})
